      ...
      <article className="bg-background py-12">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <p>Walkable retail, HOA commons, and I-15 access in under 5 minutes are the listing facts. Elementary schools are within walking distance; Vista Heights Middle is the zoned middle school.</p>
            <p><strong>Housing notes:</strong> Townhomes, custom single-family, and HOA-maintained commons. Strong Silicon Slopes commute.</p>
            ...
            <h2>2. Thanksgiving Point: Museums, Gardens, and Golf</h2>
            <p>Built around the Thanksgiving Point campus, which includes the Museum of Natural Curiosity, Ashton Gardens, a dinosaur museum, and an 18-hole golf course. Streets are tree-lined, lots are medium-sized, and the pace is less retail-dense than Traverse Mountain.</p>
            <p>Priced $500K–$800K for single-family homes. Dry Creek Elementary is the zoned elementary in Alpine School District.</p>
            <p><strong>Housing notes:</strong> Established single-family streets, medium lots, garden and museum adjacency.</p>
            <p><strong>Investment note:</strong> Stable rental market with longer tenancies on well-maintained 3–4 bedroom homes when renewals stay near comps.</p>
            ...
            <p><strong>Housing notes:</strong> Pre-1970s ramblers and bungalows, Main Street adjacency, renovation inventory.</p>
