  ...
  return (
    <ArticleShell
      meta={{
        ...
        image,
        keywords,
        bannerSubtitle: "Two distinct rental markets separated by four miles: understand both before you invest.",
      }}
    >
            ...
            <ul>
              ...
              <li>The BYU academic calendar creates predictable vacancy windows that experienced Provo landlords plan around</li>
            </ul>
            <p>Average rents in Provo near BYU: $700–$950/room in shared housing; $1,400–$1,900/mo for 2BR units; $1,800–$2,400/mo for 3BR units farther from campus.</p>

            <h2>Provo Beyond BYU</h2>
            <p>Downtown Provo and the Joaquin neighborhood have seen significant investment and revitalization. Walkable 1–2BR product near downtown leases with less academic-year seasonality than campus-adjacent housing. The 1–2BR segment in the $1,500–$2,100/month range performs well here with 3–5% vacancy.</p>

            <h2>Orem: UVU and Year-Round 3–4 Bedroom Demand</h2>
            <p>Utah Valley University (UVU) is Utah's largest university by enrollment, approximately 42,000 students. Compared with BYU-adjacent Provo, UVU has a higher share of commuter and part-time enrollment, so demand splits between studios/1BR units and 3–4 bedroom homes rather than concentrating in approved student housing.</p>
            <p>Orem's rental market is more year-round than near-campus Provo. Key characteristics:</p>
            <ul>
              <li>Strong demand for 3–4BR single-family rentals from households renting rather than buying</li>
            ...
            <h2>Silicon Slopes Commute Demand Across Both Markets</h2>
            <p>Lehi and Draper employment has created a second demand tier across both Provo and Orem: 2–3BR properties at $2,000–$3,000/month with 12–24 month leases. Properties with high-speed internet infrastructure, dedicated home office space, and modern kitchens command premium rents in this band.</p>

            <h2>Investment Profile: Provo vs Orem</h2>
            <ul>
              <li><strong>Provo near BYU:</strong> Higher turnover, higher gross yield, more intensive management. Fits active investors comfortable with student housing product and seasonal leasing cycles.</li>
              <li><strong>Downtown Provo / Joaquin:</strong> Longer tenancies, premium rents, lower management intensity. Fits investors seeking a balanced profile.</li>
              <li><strong>Orem SFR:</strong> More year-round occupancy, moderate yield, Alpine School District zoning. Fits long-horizon investors seeking capital preservation with positive cash flow.</li>
              <li><strong>Orem near UVU:</strong> Mixed academic-year and 3–4BR demand. Good value-add opportunities in older housing stock.</li>
            </ul>

            <h2>Seasonal Leasing Calendar for Utah County</h2>
            <ul>
              <li><strong>January–February:</strong> Moderate activity, BYU winter semester arrivals, some non-academic-year moves</li>
