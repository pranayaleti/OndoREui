...
export function buildLlmsTxtBody(): string {
  const lines: string[] = [
    ...
    "- **Notary**: Remote online notarization (RON), on-demand / same-day when capacity allows, loan signings, mobile notary, estate and employer packages.",
