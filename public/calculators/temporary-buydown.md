...
- Note rate
- Term (years)
- Structure (flat / 2-1 / 3-2-1)
- Flat rate reduction and years (if flat)

## Notes

- Buydown subsidy is typically prepaid by the seller or builder; the note rate itself does not change.

## Try the interactive version

- HTML calculator: https://www.ondorealestate.com/calculators/temporary-buydown/
